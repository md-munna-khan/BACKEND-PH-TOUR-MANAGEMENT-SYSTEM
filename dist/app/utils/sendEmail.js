...
const sendEmail = (_a) => __awaiter(void 0, [_a], void 0, function* ({ to, subject, attachments, templateName, templateData }) {
    try {
        const templatePath = path_1.default.join(__dirname, `templates/${templateName}.ejs`); //grabbing the file path for ejs 
        ...
        throw new app_error_1.default(401, "Email error");
    }
});
